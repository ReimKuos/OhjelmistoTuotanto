...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_saman_ostoken_tekeminen_toimii(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kahden_eri_ostoken_tekeminen_toimii(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_loppuneen_tuotteen_ostaminen_ei_onnistu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloitus_nolla_ostokset(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
